...
const Article = ({text, title, tags, image, alt}) => {
  return (
    <div className='p-5 bg-gray-200 dark:bg-dark-200 sm:rounded-xl sm:shadow-lg flex flex-col items-center gap-2 sm:hover:shadow-lg sm:hover:shadow-gray-500 sm:hover:dark:shadow-black'>
